...
-- Default users --
INSERT IGNORE INTO users (id, first_name, last_name, email, password, enable, address, role_id) VALUES ('019f1459-2ba9-4e50-8790-b77f2dbe3edb', 'Juan', 'Perez', 'admin@gmail.com', '$2a$10$Wbf68broDf6d3vukl46b5.bjPuoppqsOpWPdgdNxRurwGI/0Jac5K', true, 'La Paz', '94dcfd3f-2367-4ab4-bd81-4b6764513dc5');
INSERT IGNORE INTO users (id, first_name, last_name, email, password, enable, address, role_id) VALUES ('7c083cd5-3919-4c23-a136-fac659b23c96', 'Ana', 'Perez', 'user@gmail.com', '$2a$10$QTm97JVJjRcW0cOwSHHJnOIaMPV3KzGvgZE8KIh4YvN82mSNcWgOO', true, 'El Alto', 'a1b6d042-1be4-4907-9814-daf110a473f9');
